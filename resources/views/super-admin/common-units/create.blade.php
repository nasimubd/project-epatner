...
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    <div class="p-6 bg-white border-b border-gray-200">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Create New Unit</h2>
            <p class="text-gray-600 mt-1">Add a new common unit to the system</p>
        </div>

        <form action="{{ route('super-admin.common-units.store') }}" method="POST">
            @csrf

            <div class="mb-6">
                <label for="unit_name" class="block text-sm font-medium text-gray-700 mb-1">Unit Name</label>
                <input type="text" name="unit_name" id="unit_name" value="{{ old('unit_name') }}"
