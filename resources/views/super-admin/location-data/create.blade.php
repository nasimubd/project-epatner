...
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    <div class="p-6 bg-white border-b border-gray-200">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Add New Location</h2>
            <p class="text-gray-600 mt-1">Add a new location to the hierarchy system</p>
        </div>

        <form action="{{ route('super-admin.location-data.store') }}" method="POST" id="locationForm">
            @csrf
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <p id="location-preview" class="text-gray-600 italic">Enter location details to see preview</p>
            </div>
