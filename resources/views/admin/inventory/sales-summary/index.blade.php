...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg px-4 py-3 text-white shadow-lg">
                        <div class="text-xs font-medium opacity-90">Total Sales</div>
                        <div class="text-lg sm:text-xl font-bold">৳{{ number_format($totalSales, 0) }}</div>
                    </div>
                    <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg px-4 py-3 text-white shadow-lg">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{ route('admin.inventory.sales-summary') }}" method="GET" class="space-y-4">
                    <!-- Date Range Section -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                <button type="submit"
                                    class="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-3 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 font-medium text-sm flex items-center justify-center">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            @endphp
            <a href="{{ route('admin.inventory.category-sales-summary', [
                    'category' => $category['id'],
                    'start_date' => $startDate,
                    'end_date' => $endDate
                ]) }}"
                class="group bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl hover:border-blue-300 transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">

                <!-- Category Header -->
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-4 group-hover:from-blue-600 group-hover:to-blue-700">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-bold text-white truncate">{{ $category['name'] }}</h3>
                        <svg class="w-6 h-6 text-blue-200 group-hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-600 mb-1">
                            ৳{{ number_format($category['total_sales'], 0) }}
                        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-600 mb-2">No Sales Data Found</h3>
            <p class="text-gray-500 mb-6">No sales were recorded for the selected date range.</p>
