...
<div class="container mx-auto">
    ...
    <div class="flex justify-center mb-4 print:hidden">
        <div class="bg-white rounded-lg shadow w-full max-w-3xl p-4">
            <form action="{{ route('admin.inventory.category-damage-summary', $category->id) }}" method="GET"
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.inventory.damage-summary', ['start_date' => $startDate, 'end_date' => $endDate]) }}"
    ...
    <div class="w-[80mm] mx-auto bg-white p-2 print:p-0 print:shadow-none shadow">
        ...
        <div class="text-center border-b border-dashed pb-2">
            ...
            <h3 class="text-sm font-semibold mt-1">Damage Report</h3>
        ...
        <!-- Products List -->
        <div class="text-sm">
            @php $totalDamage = 0; @endphp
            @foreach($products as $product)
            @php $totalDamage += $product['total']; @endphp
        ...
        <div class="border-t border-dashed mt-2 pt-2">
            <div class="flex justify-between font-bold text-sm">
                ...
                <span>৳{{ number_format($totalDamage, 2) }}</span>
            </div>
        </div>
    </div>
</div>
